...
# url = 'http://dict-co.iciba.com/api/dictionary.php?type=json&key=FB438A97C59E33E602982A41CC67A945&w=%s' % query.encode('utf-8');
# f = urllib.urlopen(url);

prefix = 'http://dict-co.iciba.com/api/dictionary.php?'
url_arg = {'type': 'json',
'key': 'FB438A97C59E33E602982A41CC67A945',
'w' : query.encode('utf-8')}

f = urllib.urlopen(prefix + urllib.urlencode(url_arg))
content = f.read();  
